...
extern "C" DLLEXPORT Reader* CreateReaderObjA3(CString readerName, CString protocolVersion,CString portType, CString connStr);
...
extern "C" DLLEXPORT FilterByTime_6C* CreateFilterByTime_6C(unsigned char opType, 
															unsigned char *time,
...
extern "C" DLLEXPORT SelectTag_6C* CreateSelectTag_6CEx(unsigned char memoryBank,
														unsigned char ptr, 
